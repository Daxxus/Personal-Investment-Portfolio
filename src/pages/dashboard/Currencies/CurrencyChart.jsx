...
export default function StackedAreas({selectedCurrencies, rates}) {
  const years = Object.keys(rates)?.map(key => key)
  console.log(years);
  // Object.keys(rates)?.map(key => console.log(key))
  // console.log(year);
